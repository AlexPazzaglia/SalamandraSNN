...
def main():
    ...
    results_path = '/data/pazzagli/simulation_results/{}/optimization/swimming/target_speed'

    analysis_names = [
        'net_farms_4limb_1dof_swimming_target_speed_100',
        # 'net_farms_4limb_1dof_swimming_target_speed_101',
    ]
