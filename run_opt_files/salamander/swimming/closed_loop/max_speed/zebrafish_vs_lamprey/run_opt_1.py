...
def main():
    ...
    params_processes_shared = {
        'connectivity_axial_filename': 'connectivity_axis_salamandra_lampreylike',
    ...
    params_processes_shared['simulation_data_file_tag'] = 'swimming_closedloop_max_speed_lampreylike'
    pars_optimization = [
