...
def main():
    ...
    params_processes_shared = {
        'connectivity_limbs_filename': 'connectivity_limb_salamandra_descending',
    ...
    params_processes_shared['ps_gain_axial'] = 0
    params_processes_shared['simulation_data_file_tag'] = 'walking_openloop_max_speed_descending'
    pars_optimization = [
