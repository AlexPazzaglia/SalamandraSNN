...
def main():
    ...
    results_path = '/data/pazzagli/simulation_results/{}/optimization/walking/max_speed'
    sys.path.append(results_path)

    folder_names = [
        # 'net_farms_4limb_1dof_walking_openloop_max_speed_100',
        'net_farms_4limb_1dof_walking_openloop_max_speed_101',      #
        # 'net_farms_4limb_1dof_walking_closedloop_max_speed_100',
        'net_farms_4limb_1dof_walking_closedloop_max_speed_101',    #
    ]
