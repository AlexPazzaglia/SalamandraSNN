...
def main():
    ...
    simulation_data_file_tag = 'spinal_transection'
    ...
    params_process['mech_sim_options']['video'] = True

    # Params runs
    params_runs = [
        {
            'ps_weight'    : 5.0,
            'stim_a_off'   : [0.7, 0.7, 0.7, -2.0, -2.0, -2.0],

            'n_transections'         : 1,
            'transected_populations' : ['cpg', 'ps', 'rs'],
        }
    ]
