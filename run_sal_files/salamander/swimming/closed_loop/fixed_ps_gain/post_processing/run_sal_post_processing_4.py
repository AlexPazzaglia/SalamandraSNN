...
def main():
    ...
    results_path = '/data/pazzagli/simulation_results/data/1_sensitivity_analysis/salamander/swimming/closed_loop/swimming/closed_loop'

    folder_name = 'net_farms_limbless_swimming_cpg_neural_parameters_ps_095_100_2023_10_20_16_54_47_SENSITIVITY'
