...
def get_sal_run_params(
    ...
    ps_weight_nominal = sal_problem['ps_weight_nominal']
    ...
    params_run = [
        {
            ...
            'ps_weight' : sampled_values_run[ps_variable_ind] if sampled_values_run[ps_variable_ind] > 0.001 else 0.0,
        }
