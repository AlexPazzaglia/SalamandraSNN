...
def run_experiment(
    ...
    var_range     = [0.95, 1.05]
    ps_gain_range = [alpha_fraction_th - 0.05, alpha_fraction_th + 0.05]
    ...
    sal_problem = {
        ...
        'bounds'  : [ var_range for _ in sal_variables_keys[:-1] ] + [ ps_gain_range ],
        'ps_gain_axial_nominal': alpha_fraction_th,
    }
