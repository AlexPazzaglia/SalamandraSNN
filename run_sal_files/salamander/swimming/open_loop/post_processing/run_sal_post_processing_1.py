...
def main():
    ...
    results_path = '/data/pazzagli/simulation_results/data/1_sensitivity_analysis/salamander/swimming/open_loop/swimming/open_loop'

    folder_name = 'net_openloop_4limb_1dof_unweighted_swimming_cpg_neural_parameters_100_2023_09_29_01_55_20_SENSITIVITY'
