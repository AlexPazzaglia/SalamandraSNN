...
def main():
    ...
    results_path = '/data/pazzagli/simulation_results/data/1_sensitivity_analysis/salamander/swimming/open_loop/'

    folder_name = 'net_openloop_4limb_1dof_unweighted_swimming_cpg_neural_parameters_to_trefr_100_2023_10_05_00_15_48_SENSITIVITY'
