...
def main():
    ...
    params_runs = get_run_params_for_multi_joint_activations(
        ...
        gains_scalings_alpha = gains_scalings_beta,
        gains_scalings_beta  = gains_scalings_beta,
        gains_scalings_delta = gains_scalings_delta,
        amp_arr              = np.linspace(1.0, 0.5, N_JOINTS_AXIS),
        ipl_arr              = np.linspace(0, 1.0, N_JOINTS_AXIS)
    )
...
if __name__ == '__main__':
    ...
    OPTIMIZATION_NAME         = 'muscle_parameters_optimization_FN_10000_ZC_2000_G0_785'
    OPTIMIZATION_ITERATION    = 99

    USE_INERTIAL_SCALINGS     = False
    GLOBAL_SCALING            = 10

    # scaled_muscle_parameters_FN_1500_ZC_1000_G0_785_joint_3_activation_2_Hz
