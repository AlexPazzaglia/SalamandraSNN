...
def get_ps_to_ax_ex(amp, max_ps_range = 0.025):
    ''' Get the proprioceptive feedback connections '''
    return {
...
def get_ps_to_mn_ex(amp, max_ps_range = 0.025):
    ''' Get the proprioceptive feedback connections '''
    return {
...
def get_ps_to_ax_in(amp, max_ps_range = 0.025):
    ''' Get the proprioceptive feedback connections '''
    return {
...
def get_ps_to_mn_in(amp, max_ps_range = 0.025):
    ''' Get the proprioceptive feedback connections '''
    return {
