...
def main():
    ...
    folder_name  = 'net_farms_limbless_inhibition_weight_inhibition_weight_vs_feedback_100_2023_11_07_17_12_10_ANALYSIS'
    ...
    inhibition_amplitude = np.linspace(0, 3.0, 31)
