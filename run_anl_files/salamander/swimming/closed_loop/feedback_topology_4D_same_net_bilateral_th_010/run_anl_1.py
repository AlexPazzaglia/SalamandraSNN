...
def main():
    ...
    # Parameters
    simulation_data_file_tag = 'feedback_topology_strength_swimming_4dim_ex_up_ex_dw'
    ...
    params_processes_shared = default_params['params_process'] | {
        ...
        'ps_gain_axial'           : default.get_scaled_ps_gains(0.1),
    ...
    params_runs = (
        [
            ...
            for sig_ex_w  in np.linspace(0.0, 5, 21)
            for sig_ex_l  in np.linspace(0.0, max_ps_range, 11)
        ]
    )
