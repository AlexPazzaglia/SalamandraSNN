...
def main():
    ...
    # Parameters
    simulation_data_file_tag = 'feedback_topology_strength_swimming_4dim_in_up_in_dw'
    ...
    params_runs = (
        [
            ...
            for sig_in_w  in np.linspace(0.0, 5, 21)
            for sig_in_l in np.linspace(0.0, max_ps_range, 11)
        ]
    )
