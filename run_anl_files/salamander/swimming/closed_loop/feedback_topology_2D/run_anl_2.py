...
def main():
    ...
    # Parameters
    simulation_data_file_tag = 'feedback_topology_strength_swimming_2dim_mn_2'
    ...
    params_processes_variable_ex = [
        {
            'connectivity_axial_newpars' : {
                'ps2ax': [
                    ...
                    ps_connections.get_ps_to_mn_ex(amp= 0.5, sigma_up=ex_up, sigma_dw=ex_dw),
    ...
    params_processes_variable_in = [
        {
            'connectivity_axial_newpars' : {
                'ps2ax': [
                    ...
                    ps_connections.get_ps_to_mn_in(amp= 0.5, sigma_up=in_up, sigma_dw=in_dw),
    ...
    (
        ...
        start_index       = max(process_start_index, args['index_start']),
