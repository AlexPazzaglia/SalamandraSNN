...
def main():
    ...
    folder_name  = 'net_farms_limbless_inhibition_weight_ps_weight_inhibition_weight_vs_feedback_weight_alpha_fraction_th_050_100_2023_11_07_11_03_01_ANALYSIS'
    ...
    in_weight = np.linspace(0, 6.0, 31)
