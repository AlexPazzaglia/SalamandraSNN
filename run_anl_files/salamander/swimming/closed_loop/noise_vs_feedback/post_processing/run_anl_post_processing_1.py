...
def main():
    ...
    results_path = '/data/pazzagli/simulation_results/data/0_analysis/salamander/swimming/closed_loop/noise_vs_feedback/'
    folder_name  = 'net_farms_4limb_1dof_unweighted_noise_effect_vs_feedback_100_2023_10_22_20_30_13_ANALYSIS'
    ...
    # Grid search values
    # NOTE: 10 processes, 31 stim_a_off, 30 ps_gain_ax
