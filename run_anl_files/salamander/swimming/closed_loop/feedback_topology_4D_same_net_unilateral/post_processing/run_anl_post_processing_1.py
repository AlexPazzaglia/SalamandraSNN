...
def main(
    ...
    results_path = '/data/pazzagli/simulation_results/data/0_analysis/salamander/swimming/closed_loop/feedback_topology_4D_th_010'
    folder_name  = 'net_farms_limbless_feedback_topology_feedback_topology_strength_swimming_4dim_ex_up_100_2023_11_09_20_14_56_ANALYSIS'
    ...
    # Plot
    metrics_limits = metrics_limits if metrics_limits else {}
    studied_metrics = {
        'freq_ax'  : {
                'name'   : 'Frequency',
                'label'  : 'Frequency [Hz]',
                'values' : np.array( metrics_processes['neur_freq_ax'] ),
                'limits' : metrics_limits.get('freq_ax',[0, 5.5]),
            },
        'ptcc_ax'  : {
                'name'   : 'PTCC',
                'label'  : 'PTCC [#]',
        ...
        # 'n2m_lag_all'  : {
        #         'name'   : 'Neuro-Muscular lag',
        #         'label'  : 'Neuro-Muscular lag',
        #         'values' : np.array( metrics_processes['mech_n2m_lag_ax_all'] ),
        #         'limits' : metrics_limits.get('n2m_lag_all',[-1, 1]),
        #     },
    }
