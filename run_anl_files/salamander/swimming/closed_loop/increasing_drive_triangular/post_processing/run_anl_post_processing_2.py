...
def main():
    ...
    results_path = '/data/pazzagli/simulation_results/data/0_analysis/salamander/swimming/closed_loop/increasing_drive_triangular'
    folder_name  = 'net_farms_limbless_drive_effect_triangular_065_100_2023_10_23_16_07_31_ANALYSIS'
    ...
    # Grid search values
    # NOTE: 20 processes, 26 stim_a_off, 16 stim_h_off
    stim_a_amp = np.linspace(-2, 3, 26) + 5.0
    stim_h_off = np.linspace(-1.5, 1.5, 16)


    for _metric_name, metric_pars in studied_metrics.items():

        metric_vals = np.array( metric_pars['values'] ).reshape(20, 26, 16)
